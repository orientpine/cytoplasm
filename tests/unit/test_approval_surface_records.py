    ...
    (
        (
            ...
            ("slug", "plaintext_sha256", "dest_folder_id", "mode", "expiry_ts", "nonce", "state",
             "message_id", "created_ts", "approval_ts", "approval_thread_id", "approval_guild_id", "render_version", "kind", "surface",
             "channel_id", "policy_version"),
            (),
        ),
        (
            ...
            ("ticket_id", "patch_name", "action_hash", "nonce", "message_id", "created_at",
             "content_binding_version", "patch_sha256", "changes", "patch_source_path", "approval_guild_id",
             "render_version", "content_sha256", "kind", "surface", "channel_id", "policy_version"),
            (),
        ),
    ),
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            ("draft_id", "sha256", "dm_channel_id", "dm_message_id", "created", "render_version", "key",
        ...
        (
            ...
            ("draft_id", "sha256", "dm_channel_id", "dm_message_id", "slot", "summary",
             ...
             "origin_channel_id", "origin_message_id", "approval_thread_id", "approval_guild_id", "render_version", "key",
             "kind", "surface", "channel_id", "policy_version"),
        ),
    ),
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            "PublishSpec",
            ("skill", "digest", "manifest_hash", "tag", "publish_nonce", "binding", "render_version", "posted_text"),
